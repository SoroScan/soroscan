 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetNotifications($notificationType: String, $unreadOnly: Boolean, $limit: Int) {\n  notifications(\n    notificationType: $notificationType\n    unreadOnly: $unreadOnly\n    limit: $limit\n  ) {\n    id\n    notificationType\n    title\n    message\n    link\n    isRead\n    createdAt\n  }\n  unreadNotificationCount\n}\n\nmutation MarkNotificationRead($id: Int!) {\n  markNotificationRead(notificationId: $id)\n}\n\nmutation MarkAllNotificationsRead {\n  markAllNotificationsRead\n}\n\nmutation ClearAllNotifications {\n  clearAllNotifications\n}\n\nsubscription OnNotification {\n  notifications {\n    id\n    notificationType\n    title\n    message\n    link\n    isRead\n    createdAt\n  }\n}"): (typeof documents)["query GetNotifications($notificationType: String, $unreadOnly: Boolean, $limit: Int) {\n  notifications(\n    notificationType: $notificationType\n    unreadOnly: $unreadOnly\n    limit: $limit\n  ) {\n    id\n    notificationType\n    title\n    message\n    link\n    isRead\n    createdAt\n  }\n  unreadNotificationCount\n}\n\nmutation MarkNotificationRead($id: Int!) {\n  markNotificationRead(notificationId: $id)\n}\n\nmutation MarkAllNotificationsRead {\n  markAllNotificationsRead\n}\n\nmutation ClearAllNotifications {\n  clearAllNotifications\n}\n\nsubscription OnNotification {\n  notifications {\n    id\n    notificationType\n    title\n    message\n    link\n    isRead\n    createdAt\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
