...
class SorobanClient:
    ...
    def remove_indexer(self, indexer_address: str) -> TransactionResult:
        """
        Submit a remove_indexer transaction to the SoroScan contract (SC-14).
