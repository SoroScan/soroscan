...
def test_single_leaf_node():
    ...
    The current leaf is '0041_contractevent_contract_db_index'
    """
    ...
    assert leaf_nodes[0][1] == "0041_contractevent_contract_db_index", (
        "Expected leaf node '0041_contractevent_contract_db_index', "
