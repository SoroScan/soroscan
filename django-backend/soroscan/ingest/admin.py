...
class TransactionCostAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        "tx_hash", "contract", "function_name", "ledger_sequence",
        "total_fee_stroops", "cpu_instructions_used", "memory_bytes_used",
        "network_bytes_used", "is_outlier", "created_at",
    ]
    ordering = ["-created_at"]
    date_hierarchy = "created_at"
...
class CostAggregateAdmin(admin.ModelAdmin):
    list_display = [
        "contract_name", "function_name", "period_start",
        "avg_fee_stroops", "min_fee_stroops", "max_fee_stroops",
        "call_count", "stddev_fee_stroops", "computed_at",
    ]
    list_filter = ["function_name", "period_start"]
    search_fields = ["contract__name", "contract__contract_id", "function_name"]
    readonly_fields = [
        "contract", "function_name", "period_start", "avg_fee_stroops",
        "min_fee_stroops", "max_fee_stroops", "total_fee_stroops",
        "call_count", "stddev_fee_stroops", "computed_at",
    ]
